...
public class BlobBlock extends SymbolBlock {
    public BlobBlock(BlockBehaviour.Properties properties) {
        super(properties);
        COLOR = Color.BLACK;
    }

    public BlobBlock(BlockBehaviour.Properties properties, Color color) {
        super(properties);
        COLOR = color;
    }
